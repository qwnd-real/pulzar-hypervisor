...
//!
//! Two faces onto one register file. Through the memory-mapped page a register
//! is a byte offset; through x2APIC it is a model-specific register index, and
//! the index is *derived* from the offset. So there is one list of registers
